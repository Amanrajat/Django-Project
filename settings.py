...
SECRET_KEY = 'django-insecure-(&daa!5azo+im+v^)9j_(0$1qogu)6*1q9jz6wjzo2wcw#o4#t'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Folder for static files

LOGIN_URL = '/accounts/login'

LOGIN_REDIRECT_URL = '/tweet/'
LOGOUT_REGIRECT_URL = '/tweet/'
